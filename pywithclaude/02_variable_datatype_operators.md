...
print(f"Khách hàng {ten_khach} thanh toán {tong_tien} VNĐ")  # f-string còn tính toán được trực tiếp bên trong {}
print(f"Sau khi giảm 10%: {tong_tien * 0.9} VNĐ")  # Định dạng số - ví dụ làm tròn 2 chữ số thập phân gia = 1234.5678
