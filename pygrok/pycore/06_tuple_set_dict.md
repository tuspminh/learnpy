...
Đây là 3 cấu trúc dữ liệu quan trọng còn lại của Python.  
Sau bài này bạn sẽ nắm gần như toàn bộ cách lưu trữ dữ liệu cơ bản.
...
```python
# Tạo dictionary
sinh_vien = {"ten": "Nguyễn Văn A", "tuoi": 20, "diem": 8.5, "da_tot_nghiep": False}
```
...
**Bài 1: Tuple**  
Cho tuple: `thong_tin = ("An", 20, 8.5, "CNTT")`  
- In từng phần tử  
...
**Bài 3: Dictionary**  
Tạo dictionary lưu thông tin 3 học sinh (mã SV làm key).  
Mỗi học sinh có: tên, tuổi, điểm.  
...
Tôi sẽ chữa bài và mở **Bài 7: Hàm (Function)** – một trong những bài quan trọng nhất.
