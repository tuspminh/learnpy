...
**Bài 1:**  
Cho chuỗi: `s = "  Python Programming  "`  
...
**Bài 2:**  
Viết chương trình nhập vào họ tên đầy đủ (có thể thừa khoảng trắng).  
In ra họ tên đã được chuẩn hóa (xóa khoảng trắng thừa + viết hoa chữ cái đầu mỗi từ).
...
**Bài 3:**  
Viết hàm `dem_ky_tu(chuoi)` trả về dictionary đếm số lần xuất hiện của mỗi ký tự (bỏ qua khoảng trắng).
...
**Bài 4:**  
Viết chương trình kiểm tra một chuỗi có phải là **palindrome** không (đọc xuôi ngược giống nhau).  
Ví dụ: `"radar"`, `"level"`, `"12321"` là palindrome.

**Bài 5 (nâng cao):**  
Viết hàm `chuan_hoa_email(email)`:
...
Tôi sẽ chữa bài và mở **Bài 9: Module & Package** (cách tổ chức code và dùng thư viện).
