...
**Bài 1:** Tạo các biến sau và in ra kiểu dữ liệu của chúng:
...
**Bài 3:** Cho đoạn code sau, đoán kết quả rồi chạy thử để kiểm tra:
...
**Bài 4 (nâng cao nhẹ):** Viết chương trình nhập chiều cao (m) và cân nặng (kg), tính BMI theo công thức:
...
Làm xong gửi code + kết quả chạy cho tôi. Tôi sẽ chữa bài và mở **Bài 3: Câu lệnh điều kiện (if – elif – else)** ngay.
