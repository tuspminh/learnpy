...
Hàm là một trong những khái niệm **quan trọng nhất** của lập trình. Hàm giúp bạn chia chương trình thành các khối nhỏ, dễ đọc, dễ bảo trì và tái sử dụng.
...
**Bài 1:** Viết hàm chao_hoi(ten, nam_sinh) in ra câu chào và tuổi hiện tại (năm 2026).

**Bài 2:** Viết hàm kiem_tra_chan_le(n) trả về "Chẵn" hoặc "Lẻ".

**Bài 3:** Viết hàm tinh_tong_danh_sach(ds) nhận vào một list số và trả về tổng các phần tử.

**Bài 4:** Viết hàm tim_max_min(ds) trả về cả giá trị lớn nhất và nhỏ nhất của list (dùng return 2 giá trị).

**Bài 5:** Viết hàm tinh_bmi(can_nang, chieu_cao) trả về BMI. Sau đó viết thêm hàm phan_loai_bmi(bmi) trả về:
...
**Bài 6 (nâng cao):** Viết hàm thong_ke(*args) nhận bao nhiêu số cũng được, trả về dictionary gồm:
...
Làm xong gửi code + kết quả chạy. Tôi sẽ chữa bài và mở **Bài 8: Xử lý chuỗi (String)** hoặc **Bài 9: Module & Package** (tùy bạn muốn đi theo hướng nào trước).
