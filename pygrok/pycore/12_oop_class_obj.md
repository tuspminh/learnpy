...
**Class** = khuôn mẫu (bản thiết kế) **Object** = thực thể cụ thể được tạo ra từ khuôn mẫu đó
...
**Bài 2:** Tạo class HinhChuNhat có:
...
**Bài 4:** Tạo class TaiKhoan (giống ví dụ ngân hàng ở trên) và bổ sung thêm:
...
**Bài 5 (nâng cao):** Tạo class HocSinh và viết chương trình quản lý danh sách học sinh:
...
Làm xong gửi code + kết quả. Tôi sẽ chữa bài và mở **Bài 13: OOP Phần 2 – Inheritance (Kế thừa)**.
