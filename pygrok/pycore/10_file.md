...
Hầu hết chương trình thực tế đều cần đọc/ghi dữ liệu ra file.  
Nắm vững bài này bạn sẽ làm được lưu điểm, danh bạ, nhật ký, xuất báo cáo…
...
```python
hoc_sinh = ["An,8.5", "Bình,7.0", "Chi,9.2"]
...
**Bài 2:**  
Viết chương trình nhập tên và điểm của nhiều học sinh (nhập đến khi tên = `"x"` thì dừng).  
Lưu vào file `diem.txt` theo định dạng:
```
An,8.5
Bình,7.0
Chi,9.2
...
**Bài 3:**  
Viết chương trình đọc file `diem.txt` ở trên, sau đó:
- In ra toàn bộ danh sách
- Tính điểm trung bình
- Tìm học sinh có điểm cao nhất

**Bài 4:**  
Viết chương trình đếm số dòng, số từ và số ký tự trong một file bất kỳ.
...
Tôi sẽ chữa bài và mở **Bài 11: Xử lý Exception (try – except)**.
