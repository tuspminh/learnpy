...
Khi chương trình ngày càng lớn, bạn không thể viết hết code trong một file. Module và Package giúp bạn **tổ chức code** thành các phần riêng biệt, dễ quản lý và tái sử dụng.
...
Khi bạn chạy trực tiếp một file, Python gán __name__ = "__main__". Khi file đó bị import, __name__ sẽ là tên module.
...
**Tại sao cần?** Để tránh code test chạy lung tung khi module bị import.
...
**Bài 1:** Dùng module math để tính:
...
**Bài 2:** Viết chương trình dùng random để:
...
**Bài 4:** Tự tạo module tên xu_ly_chuoi.py gồm các hàm:
...
**Bài 5 (nâng cao):** Viết chương trình đoán số hoàn chỉnh:
...
Làm xong gửi code + kết quả. Tôi sẽ chữa bài và mở **Bài 10: Xử lý File (Đọc & Ghi file)**.
