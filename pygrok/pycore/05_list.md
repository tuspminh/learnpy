...
List là cấu trúc dữ liệu **quan trọng nhất** và dùng nhiều nhất trong Python.  
List dùng để lưu nhiều giá trị trong một biến, có thể thay đổi được (mutable).
...
**Bài 1:**  
Tạo một list chứa 5 tên bạn bè. Sau đó:
...
**Bài 2:**  
Cho list: `so = [4, 7, 1, 9, 3, 6, 2]`  
- Tìm số lớn nhất, nhỏ nhất (không dùng `max`, `min`)
- Tính tổng các phần tử
- Đếm có bao nhiêu số chẵn

**Bài 3:**  
Viết chương trình nhập `n` số nguyên từ bàn phím, lưu vào list, rồi in ra:
- List vừa nhập
- List đã được sắp xếp tăng dần
- Số phần tử của list

**Bài 4 (nâng cao):**  
Cho list điểm của học sinh:  
`diem = [7.5, 8.0, 4.5, 9.0, 6.5, 3.5, 8.5]`  
...
Tôi sẽ chữa bài và mở **Bài 6: Tuple, Set và Dictionary**.
