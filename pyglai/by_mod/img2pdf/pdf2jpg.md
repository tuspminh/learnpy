...
## Ví dụ mã nguồn nhanh## Sử dụng PyMuPDF

import fitz  # PyMuPDF
doc = fitz.open("file.pdf")for i, page in enumerate(doc):
  pix = page.get_pixmap()
...
images = convert_from_path("file.pdf")for i, image in enumerate(images):
