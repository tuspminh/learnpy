...
# Cách 1: Dùng hàm yield (Đã viết ở trên)luong_loc_loi = loc_dong_loi(luong_doc_file)
# Cách 2: Dùng Generator Expression (Ngắn gọn chỉ trong 1 dòng)luong_loc_loi_nhanh = (dong.strip() for dong in luong_doc_file if "ERROR" in dong)
