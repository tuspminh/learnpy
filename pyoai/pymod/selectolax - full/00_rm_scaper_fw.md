...
## **Phần IV — Xây dựng một Scraper Framework thực tế**:

```text
Buổi 21 — Base Parser / Base Extractor
Buổi 22 — Multi-site Extractor
Buổi 23 — URL & Link Extractor
Buổi 24 — Pagination Engine
Buổi 25 — HTML Cleaner
Buổi 26 — Article Content Extractor
Buổi 27 — Image Extractor
Buổi 28 — Metadata / JSON-LD
Buổi 29 — Site Plugin Architecture
Buổi 30 — Scraper Pipeline
Buổi 31 — Selectolax + HTTPX + SQLite
Buổi 32 — Mini Project: Article Scraper Framework
```
